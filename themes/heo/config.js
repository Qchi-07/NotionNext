const CONFIG = {
  ...
  HEO_SITE_CREATE_TIME: '2026-03-21', // 建站日期，用于计算网站运行的第几天

  // 首页顶部通知条滚动内容，如不需要可以留空 []
  HEO_NOTICE_BAR: [
    { title: '', url: '' },
    { title: '建议收藏好本站丨防走失备用网站丨点击跳转', url: 'https://my.feishu.cn/wiki/GoXAwsO2AiKOBOksd0ZcxmeTnUd' },
  ...
  HEO_HERO_CATEGORY_3: { title: '网赚教程', url: '/tag/X赛道实操教程' },
